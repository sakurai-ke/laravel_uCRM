...
// 詳細不明だがpropsで情報を受け取り表示する際に時刻の表示がおかしくなるらしく、javascript側のライブラリで表示を修正する
...
// 説明なしのため詳細不明だがprops.orders.dataの中にPurchaseControllerで指定したordersの情報が
// 含まれているらしい？
onMounted(() => {
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <section class="text-gray-600 body-font">
                          ...
                          <!-- 説明なしのため詳細不明だがprops.orders.linksの中にPurchaseControllerで指定したordersのページネーションの情報が
                          含まれているらしい？ -->
